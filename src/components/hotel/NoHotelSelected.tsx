...
const NoHotelSelected: React.FC<NoHotelSelectedProps> = ({ hasHotels, onAddHotel }) => {
  return (
    <motion.div
      ...
      className="h-full flex flex-col items-center justify-center p-4 sm:p-8 sticky top-1/4 z-10"
    >
      <div className="flex flex-col items-center text-center max-w-md space-y-6 bg-background/80 backdrop-blur-sm p-6 rounded-xl shadow-sm">
