...
const UserModuleRoleSelect: React.FC<UserModuleRoleSelectProps> = ({
  ...
  // If the user is a SuperAdmin, show a locked dropdown
  if (isSuperAdmin) {
    return (
      <div className="w-[110px] flex items-center justify-between px-3 py-2 rounded-md border border-input bg-background text-sm text-muted-foreground">
