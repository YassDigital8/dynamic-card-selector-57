    ...
    <AnimatePresence mode="wait">
      ...
      >
        <Card className="shadow-md bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
          <CardHeader className="bg-blue-50 dark:bg-blue-900/30 border-b border-gray-200 dark:border-gray-700 p-1.5 sm:p-2 md:p-4">
            <CardTitle className="text-blue-800 dark:text-blue-300 flex items-center gap-1 md:gap-2 text-[10px] sm:text-xs md:text-lg">
              <Route className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5" />
              Choose Your Action
            </CardTitle>
          </CardHeader>
          <CardContent className="p-1.5 sm:p-3 md:p-5 space-y-2 sm:space-y-3 md:space-y-6">
            <Alert className="bg-blue-50 dark:bg-blue-900/20 border-blue-100 dark:border-blue-800/30 text-blue-800 dark:text-blue-300 p-1 sm:p-2 md:p-4">
              <HelpCircle className="h-2.5 w-2.5 sm:h-3.5 sm:w-3.5 md:h-4 md:w-4" />
              <AlertDescription className="text-[8px] sm:text-xs md:text-sm">
                {isMobile ? "Select path or add page" : "Choose how you want to proceed - configure a path or add a new page directly"}
              </AlertDescription>
            </Alert>
            ...
            <div className="grid grid-cols-1 gap-2 sm:gap-3 md:gap-4 mt-1 sm:mt-2 md:mt-4">
