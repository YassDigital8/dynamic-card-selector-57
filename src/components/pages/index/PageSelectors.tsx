        ...
        <AnimatePresence mode="wait">
          ...
          {currentStep === 'pos' && (
            ...
            >
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className="w-full bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 hover:border-green-400 transition-colors text-xs sm:text-sm">
                    <SelectValue placeholder="Select POS" />
                  </SelectTrigger>
                  <SelectContent className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 max-h-[40vh]">
                    {posOptions.map((pos) => (
                      <SelectItem key={pos} value={pos} className="text-black dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 text-xs sm:text-sm">{pos}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              </div>
          ...
          {currentStep === 'language' && (
            ...
            >
              ...
              <div className="text-xs sm:text-sm font-medium mb-2 sm:mb-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger className="w-full bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 hover:border-blue-400 transition-colors text-xs sm:text-sm">
                    <SelectValue placeholder="Select language" />
                  </SelectTrigger>
                  <SelectContent className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 max-h-[40vh]">
                    {languageOptions.map((lang) => (
                      <SelectItem key={lang} value={lang} className="text-black dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 text-xs sm:text-sm">{lang}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              </div>
          ...
          {currentStep === 'options' && (
            <motion.div 
              ...
              className="space-y-3 sm:space-y-4"
            >
              <Alert className="bg-green-50 border-green-100 text-green-800 p-2 sm:p-4 text-xs sm:text-sm">
                <HelpCircle className="h-3 w-3 sm:h-4 sm:w-4" />
                <AlertDescription>
              ...
              <div className="flex flex-col space-y-1 sm:space-y-2 text-xs sm:text-sm font-medium mb-1 sm:mb-2">
